...
data:
  ...
  bundledCode: "#line 1 \"test/range-queries/RSQ_RAQ_2.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_G\"\n\n#line\
    ...
    using aliases::RSQ_RAQ;\nusing aliases::RSQ_RUQ;\n\n\n#line 4 \"test/range-queries/RSQ_RAQ_2.test.cpp\"\
    \n\n#line 6 \"test/range-queries/RSQ_RAQ_2.test.cpp\"\n\nint main(){\n    int\
  ...
  verifiedWith: []
documentation_of: test/range-queries/RSQ_RAQ_2.test.cpp
layout: document
redirect_from:
- /verify/test/range-queries/RSQ_RAQ_2.test.cpp
- /verify/test/range-queries/RSQ_RAQ_2.test.cpp.html
