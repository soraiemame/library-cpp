...
data:
  ...
  bundledCode: "#line 1 \"test/range-queries/RSQ_RUQ_1.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/3/DSL/2/DSL_2_I\"\n\n#include\
    ...
    \ \",\");\n    }\n};\n\n\n#line 6 \"test/range-queries/RSQ_RUQ_1.test.cpp\"\n\n\
  ...
  verifiedWith: []
documentation_of: test/range-queries/RSQ_RUQ_1.test.cpp
layout: document
redirect_from:
- /verify/test/range-queries/RSQ_RUQ_1.test.cpp
- /verify/test/range-queries/RSQ_RUQ_1.test.cpp.html
