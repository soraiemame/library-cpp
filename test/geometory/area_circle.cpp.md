...
data:
  ...
  bundledCode: "#line 1 \"test/geometory/area_circle.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_7_I\"\
    ...
    \ vp[j])});\n        }\n    }\n    return res;\n}\n//#undef x\n//#undef y\n\n\n\
    #line 7 \"test/geometory/area_circle.cpp\"\n\nint main(){\n    std::cout << std::fixed\
  ...
  verifiedWith: []
documentation_of: test/geometory/area_circle.cpp
layout: document
redirect_from:
- /library/test/geometory/area_circle.cpp
- /library/test/geometory/area_circle.cpp.html
