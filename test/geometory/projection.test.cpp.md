...
data:
  ...
  bundledCode: "#line 1 \"test/geometory/projection.test.cpp\"\n#define PROBLEM \"\
    https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_1_A\"\n#define\
    ...
    \ vp[j])});\n        }\n    }\n    return res;\n}\n//#undef x\n//#undef y\n\n\n\
    #line 7 \"test/geometory/projection.test.cpp\"\n\nint main(){\n    std::cout <<\
  ...
  verifiedWith: []
documentation_of: test/geometory/projection.test.cpp
layout: document
redirect_from:
- /verify/test/geometory/projection.test.cpp
- /verify/test/geometory/projection.test.cpp.html
