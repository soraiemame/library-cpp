...
data:
  ...
  bundledCode: "#line 1 \"test/geometory/incircle.test.cpp\"\n#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_7_B\"\
    ...
    \ vp[j])});\n        }\n    }\n    return res;\n}\n//#undef x\n//#undef y\n\n\n\
    #line 7 \"test/geometory/incircle.test.cpp\"\n\nint main(){\n    std::cout <<\
    \ std::fixed << std::setprecision(15);\n    Point A = inputP(),B = inputP(),C\
    \ = inputP();\n    auto ans = naisin(A,B,C);\n    std::cout << ans.x << \" \"\
    \ << ans.y << \" \" << distPL(ans,line(A,B)) << \"\\n\";\n}\n"
  ...
  verifiedWith: []
documentation_of: test/geometory/incircle.test.cpp
layout: document
redirect_from:
- /verify/test/geometory/incircle.test.cpp
- /verify/test/geometory/incircle.test.cpp.html
