...
data:
  ...
  bundledCode: "#line 1 \"test/geometory/outcircle.test.cpp\"\n#define PROBLEM \"\
    https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_7_C\"\n#define\
    ...
    \ vp[j])});\n        }\n    }\n    return res;\n}\n//#undef x\n//#undef y\n\n\n\
    #line 7 \"test/geometory/outcircle.test.cpp\"\n\nint main(){\n    std::cout <<\
...
layout: document
redirect_from:
- /verify/test/geometory/outcircle.test.cpp
- /verify/test/geometory/outcircle.test.cpp.html
