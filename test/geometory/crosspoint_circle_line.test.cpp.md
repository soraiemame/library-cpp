...
data:
  ...
  bundledCode: "#line 1 \"test/geometory/crosspoint_circle_line.test.cpp\"\n#define\
    \ PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/4/CGL/all/CGL_7_D\"\
    ...
    \ vp[j])});\n        }\n    }\n    return res;\n}\n//#undef x\n//#undef y\n\n\n\
    #line 7 \"test/geometory/crosspoint_circle_line.test.cpp\"\n\nint main(){\n  \
    ...
    \        std::cout << ans[0].x << \" \" << ans[0].y << \" \" << ans[1].x << \"\
    \ \" << ans[1].y << \"\\n\";\n    }\n}\n"
  ...
  verifiedWith: []
documentation_of: test/geometory/crosspoint_circle_line.test.cpp
layout: document
redirect_from:
- /verify/test/geometory/crosspoint_circle_line.test.cpp
- /verify/test/geometory/crosspoint_circle_line.test.cpp.html
