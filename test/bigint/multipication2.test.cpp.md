...
data:
  ...
  bundledCode: "#line 1 \"test/bigint/multipication2.test.cpp\"\n#define PROBLEM \"\
    https://onlinejudge.u-aizu.ac.jp/courses/library/6/NTL/2/NTL_2_F\"\n\n#include\
    ...
    \ 2 * M1M2M3, 3 * M1M2M3};\n        x -= offset[diff % 5];\n        c[i] = x;\n\
    \    }\n\n    return c;\n}\n\n}  // namespace atcoder\n\n\n#line 7 \"test/bigint/multipication2.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/bigint/multipication2.test.cpp
layout: document
redirect_from:
- /verify/test/bigint/multipication2.test.cpp
- /verify/test/bigint/multipication2.test.cpp.html
